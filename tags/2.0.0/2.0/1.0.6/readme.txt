...
You can override the style in your style.css
...
WP Booklet relies on Ghostscript and Imagemagick for PDF conversion. If you can't see the button, then at least one of them is missing or misconfigured. You can check their statuses under WP Booklet->Settings.

Make sure that you can run both via the command-line. If you are unsure on how to do this, please contact your server administrator.
